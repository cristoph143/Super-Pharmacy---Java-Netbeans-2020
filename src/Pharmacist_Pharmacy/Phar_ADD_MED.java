...
//        try {
//                FileWriter myWriter = new FileWriter("C:\\CS Program Files Only\\Codes\\Java\\File_Handling\\src\\newpackage\\FileHandlingNewFilef1.txt");
                ...
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
            {
                ...
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
                {
                    ...
                    ConfirmMed_Pharmacist conPhar = new ConfirmMed_Pharmacist(data);
